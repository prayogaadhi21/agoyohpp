...
=== FITUR TAMBAHAN: TAMBAH/EDIT STOK DAN TERIMA BARANG ===

Saat pengujian ditemukan bahwa modul Gudang belum punya cara untuk menambah atau mengoreksi stok gudang secara manual, dan PO Eksternal yang dibuat tidak otomatis menambah stok gudang saat barang sudah diterima dari supplier. Dua fitur ini sudah ditambahkan. Pertama, form "Tambah / Edit Stok" di halaman Stok (app/gudang/stok/page.js): pilih produk dari dropdown, kalau produk sudah punya stok maka jumlahnya otomatis terisi (mode edit), kalau belum maka bisa diisi jumlah baru (mode tambah), lalu klik "Simpan Stok" (commit 9c0040a). Kedua, tombol "Terima Barang" di halaman PO Eksternal (app/gudang/po-eksternal/page.js) yang muncul untuk PO berstatus draft/dipesan; begitu diklik dan dikonfirmasi, sistem otomatis menambah jumlah warehouse_stock sesuai barang di PO tersebut dan mengubah status PO menjadi diterima (commit 69fc8a0). Kedua fitur ini sudah diuji langsung di aplikasi live dan berhasil (contoh: PO-TEST-001 berhasil diterima dan menambah stok Kopi Arabika).
